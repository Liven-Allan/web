            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h4 class="mb-0 text-primary">Create News Item</h4>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="image-upload-container border rounded p-3 text-center">
                                            <div id="image-preview" class="mb-3">
                                                <img src="{{ asset('images/default-news.jpg') }}" alt="Preview"
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-primary px-4">Create News Item</button>
                            </div>
                        </form>
                    </div>
                </div>
