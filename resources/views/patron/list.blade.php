        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('patron.users.edit', $user->id) }}" class="btn btn-warning btn-sm">Edit</a>
                        @if(($user->status ?? 'active') === 'active')
                            <form action="{{ route('patron.users.disable', $user->id) }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="btn btn-secondary btn-sm">Disable</button>
                            </form>
                        @else
                            <form action="{{ route('patron.users.enable', $user->id) }}" method="POST" class="d-inline">
                                @csrf
